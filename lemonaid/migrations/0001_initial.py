# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2016-02-06 21:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='creditor',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='single_creditor', to='lemonaid.UserProfile'),
        ),
        migrations.AddField(
            model_name='singleloan',
            name='debitor',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='single_debitor', to='lemonaid.UserProfile'),
        ),
        migrations.AddField(
            model_name='singleloan',
            name='debitor_loan',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='lemonaid.DebitorLoan'),
        ),
        migrations.AddField(
            model_name='poolloan',
            name='creditor',
            field=models.ManyToManyField(null=True, related_name='pool_creditor', to='lemonaid.UserProfile'),
        ),
        migrations.AddField(
            model_name='poolloan',
            name='debitor_loan',
        ...
        migrations.AddField(
            ...
            name='debitor',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='lemonaid.UserProfile'),
        ),
        migrations.AddField(
            model_name='cashflow',
            name='profile',
